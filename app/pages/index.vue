...
<template>
  <section class="relative isolate">
    ...
    <div class="relative z-10 container mx-auto px-4 py-16 md:py-24">
      ...
      >
        <div class="mx-auto max-w-4xl text-center">
          ...
          <!-- (1) Rainbow gradient headline + (1) animated gradient underline on keywords -->
          <h1
          ...
          <div class="mt-4 mx-auto max-w-2xl">
            <p class="text-pretty text-base md:text-lg leading-relaxed text-muted-foreground">
              ...
              <!-- Keep the word together + use a non-breaking hyphen -->
          ...
          <!-- CTA (single button with right-caret icon) -->
      ...
      <!-- (4) Soft entrance animation for preview card + (3) Gradient border wrapper -->
      <Transition
        name="fade-up"
        appear
      >
              ...
              <CardContent>
                <ul class="grid gap-3">
                  ...
                  >
                    ...
                    <div class="flex items-center gap-3 min-w-0">
                      <Checkbox
                        ...
                        class="h-5 w-5 rounded bg-background
                          ...
                          data-[state=checked]:ring-emerald-500/40
                      ...
                      <!-- allow the text to wrap/truncate within the available width -->
                      <span
                    ...
                    <!-- Right: badges (wrap on narrow screens) -->
                    <div class="flex flex-wrap items-center gap-2 sm:flex-nowrap sm:justify-end justify-center">
                      ...
                      <!-- Status badge with success/warning colors -->
                      <Badge
                        :class="todo.done
    ...
    <!-- Floating author badge (responsive: center on mobile, bottom-right on sm+) -->
    <div
      role="note"
...
/* (1) Animated multi-color gradient text */
...
/* (1) Animated gradient underline for keywords */
...
@media (prefers-reduced-motion: reduce) {
  .animated-underline { animation: none; }
}

/* (4) Fade-up transition */
.fade-up-enter-active { transition: all .25s ease; }
.fade-up-enter-from { opacity: 0; transform: translateY(6px); }

/* Full-page animated background, no horizontal overflow */
.rainbow-veil {
  /* position handled by Tailwind utilities: fixed inset-0 z-0 */
  ...
  /* wider visible area so it doesn't vanish */
